$(document).ready(function() {
  ...
  function processDownArrow() {
    ...
    } else if ($top <= -$height*2 && $left.between(-3150, 10)) {
      $left -= $width*0.05
    ...
    } else if ($left < -3150 && $top > -$height*3) {
      $top -= $height*0.05
    ...
    } else if ($top <= -$height*3 && $left.between(-3150, -12900)) {
      $left -= $width*0.05
      $harryLeft += $width*0.05
  ...
  function processUpArrow() {
    ...
    } else if ($left >= -3200 && $top.between(-$height*2, -$height*4)) {
      $top += $height*0.05
      $harryTop -= $height*0.05
      $('.content').css('top', `${$top}px`)
      $('.harry-container').css('top', `${$harryTop}px`)
    ...
    } else if ($top <= -$height*3 && $left.between(-3100, -13000)) {
      $left += $width*0.05
      $harryLeft -= $width*0.05
